        ...
        <div class="container pt-5 pb-3">
            ...
            <div class="row portfolio-container">
                ...
                <div class="col-lg-4 col-md-6 mb-4 portfolio-item second">
                    <div class="position-relative rounded overflow-hidden mb-2">
                        <img class="img-fluid w-100" src="<?php echo Asset::image('portfolio-2.jpg');?>" alt="">
                        <div class="portfolio-btn d-flex align-items-center justify-content-center">
                ...
                <div class="col-lg-4 col-md-6 mb-4 portfolio-item first">
                    <div class="position-relative rounded overflow-hidden mb-2">
                        <img class="img-fluid w-100" src="<?php echo Asset::image('portfolio-3.jpg');?>" alt="">
                        <div class="portfolio-btn d-flex align-items-center justify-content-center">
                ...
                <div class="col-lg-4 col-md-6 mb-4 portfolio-item second">
                    <div class="position-relative rounded overflow-hidden mb-2">
                        <img class="img-fluid w-100" src="<?php echo Asset::image('portfolio-4.jpg');?>" alt="">
                        <div class="portfolio-btn d-flex align-items-center justify-content-center">
                ...
                <div class="col-lg-4 col-md-6 mb-4 portfolio-item first">
                    <div class="position-relative rounded overflow-hidden mb-2">
                        <img class="img-fluid w-100" src="<?php echo Asset::image('portfolio-5.jpg');?>" alt="">
                        <div class="portfolio-btn d-flex align-items-center justify-content-center">
                            <a href="img/portfolio-3.jpg" data-lightbox="portfolio">
                                <i class="fa fa-4x fa-plus text-primary"></i>
                            </a>
                ...
                <div class="col-lg-4 col-md-6 mb-4 portfolio-item second">
                    <div class="position-relative rounded overflow-hidden mb-2">
                        <img class="img-fluid w-100" src="<?php echo Asset::image('portfolio-6.jpg');?>" alt="">
                        <div class="portfolio-btn d-flex align-items-center justify-content-center">
                            <a href="img/portfolio-4.jpg" data-lightbox="portfolio">
                                <i class="fa fa-4x fa-plus text-primary"></i>
                            </a>
